...
int main()
{
    ...
    // -------------------------
    Shader shader("Assets/Shaders/lighting.vs", "Assets/Shaders/lighting.fs");
    Shader simpleDepthShader("Assets/Shaders/shadow_depth.vs", "Assets/Shaders/shadow_depth.fs");
    ...
    // lighting info
    // -------------
    glm::vec3 lightPos(-1.0f, 35.0f, 0);
    ...
    while (!app.WindowShouldClose())
    {
        ...
        playerCar.Render(simpleDepthShader);
        ...
        shader.setMat4("viewProjection", followCamera.GetViewProjectionMatrix());
        // set light uniforms
        shader.setVec3("viewPosition", followCamera.GetPosition());
